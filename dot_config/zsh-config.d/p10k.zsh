# Generated by Powerlevel10k configuration wizard on 2024-06-13 at 16:47 UTC.
...
# 2 lines, solid, full frame, green-ornaments, sparse, many icons, fluent,
...
() {
  ...
  # Host override: on Ubuntu, use the backup-style filler and ornament colors.
  local p10k_os_id
  if [[ -r /etc/os-release ]]; then
    . /etc/os-release
    p10k_os_id=$ID
  elif (( $+commands[lsb_release] )); then
    p10k_os_id=${${(L)$(lsb_release -si)}:-}
  fi
  if [[ $p10k_os_id == ubuntu ]]; then
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_VERBOSE=true # jfo
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_SHOW_PYTHON_VERSION=true #jfo
  ...
  typeset -g POWERLEVEL9K_INSTANT_PROMPT=quiet #jfo verbose
